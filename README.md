...
[![Build Status](https://travis-ci.org/NaturesProphet/mestreDaChibata.svg?branch=master)](https://travis-ci.org/NaturesProphet/mestreDaChibata)
# Mestre da chibata
...
## Description
Web Service para receber e enviar requisições de um app do slack que irá cuidar de registrar as reuniões diárias das equipes scrum.
